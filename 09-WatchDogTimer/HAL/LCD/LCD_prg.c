...
void HLCD_vSetCursorPosition(u8 A_u8LineNo ,u8 A_u8LinePos)
{
	if(A_u8LineNo==LCD_LINE1)
	{
		HLCD_vSendCommand(INIT_CURSOR_POS+ROW_TWO+A_u8LinePos);
	}
	else
	{
		HLCD_vSendCommand(INIT_CURSOR_POS+ROW_ONE+A_u8LinePos);
	}
